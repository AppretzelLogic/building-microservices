...
// validateSKU validates the SKU field
...
// NewEncoder provides better performance than json.Marshal as it does not have to buffer the output into an in memory slice of bytes
